...
public class SupabaseStorageService {
    ...
    public String uploadChatRoomImage(Long roomId, String username, MultipartFile file) {
        if (file == null || file.isEmpty()) {
            throw new IllegalArgumentException("업로드할 파일이 비어 있습니다.");
        }
        ...
        String safeUser = safePathSegment(username);
        String safeRoom = (roomId == null ? "unknown" : String.valueOf(roomId));
        String objectPath = "chat-rooms/" + safeRoom + "/" + safeUser + "/" + UUID.randomUUID() + extension;
